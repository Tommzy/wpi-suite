...
//        AddEventPanelController.getInstance().getTabbedPane().add(new AddCommitmentPanel(null, new MigLayout()));
          AddEventPanelController.getInstance().getTabbedPane().add(new AddCommitmentPanel(new CommitmentListModel(),new MigLayout()));
