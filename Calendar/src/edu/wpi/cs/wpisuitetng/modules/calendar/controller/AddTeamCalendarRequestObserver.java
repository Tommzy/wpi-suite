 ...
 * to the server to add a TeamCalendar.
 */
public class AddTeamCalendarRequestObserver implements RequestObserver {
  
  private final AddTeamCalendarController controller;
  
  /**
   * Constructs the observer given an AddIterationController
   * @param controller the controller used to add Iterations
   */
  public AddTeamCalendarRequestObserver(AddTeamCalendarController controller) {
  ...
  public void responseError(IRequest iReq) {
    System.err.println("The request to add a TeamCalendar failed.");
  }
